                    ...
                    <div style="display: flex">
                        ...
                        <div style="display: flex; flex-direction: column">
                            ...
                            <div>
                                ...
                                <%--Building record link--%>
                                ${header['host']}/get/<span data-record-link></span>

                                <button class="btn btn-default btn-xs"><span class="glyphicon glyphicon-copy"></span></button>

                            </div>

                            <%--Record expiry time--%>
                            <div>
                                <span class="glyphicon glyphicon-time"></span> <span data-record-expiry-time></span>
